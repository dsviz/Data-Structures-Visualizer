...
import { PSEUDOCODE, CODE_CPP, COMPLEXITY, Operation } from '../../hooks/useStackVisualizer';

interface StackTabsProps {
    activeTab: 'code' | 'pseudo' | 'info';
    activeOp: Operation;
    currentFrame: any; // Type strictly if shared types available
}

export const StackTabs: React.FC<StackTabsProps> = ({ activeTab, activeOp, currentFrame }) => {
