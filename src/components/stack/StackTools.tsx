...
export type StackTool = 'edit' | null;

interface StackToolsProps {
    activeTool: StackTool;
    setActiveTool: (tool: StackTool) => void;
    onPush: () => void;
    onPop: () => void;
    onClear: () => void;
}

export const StackTools: React.FC<StackToolsProps> = ({
    activeTool,
    setActiveTool,
    onPush,
    onPop,
