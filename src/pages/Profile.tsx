...
const Profile = () => {
    ...
    return (
        <div className="h-screen w-full flex items-center justify-center relative overflow-hidden bg-background-light dark:bg-[#0a0914] transition-colors duration-500">
            ...
            <div className="w-full min-h-[100dvh] relative z-10 bg-white/30 dark:bg-[#131221]/50 backdrop-blur-[40px] p-6 sm:p-10 transition-all flex flex-col justify-center items-center overflow-y-auto">
