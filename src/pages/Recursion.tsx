...
const Recursion = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Interactive Recursion Visualizer | Data Structures & Algorithms</title>
                <meta name="description" content="Visualize recursion with interactive call stack and execution trace animations. Perfect for understanding recursive algorithms." />
            </Helmet>
            <div className="flex flex-col h-screen overflow-hidden bg-background-light dark:bg-background-dark text-slate-900 dark:text-white font-display">
                <h1 className="sr-only">Interactive Recursion Visualizer</h1>
