            ...
            <div className="relative z-10 max-w-md w-full space-y-8 bg-white/70 dark:bg-white/5 backdrop-blur-2xl p-8 sm:p-10 rounded-3xl shadow-2xl border border-white/20 dark:border-white/10 mx-4 transition-all">
                <div className="text-center">
                    <div className="flex justify-center mb-4">
                        <div className="w-16 h-16 bg-gradient-to-tr from-indigo-500 to-primary rounded-2xl flex items-center justify-center shadow-[0_0_30px_rgba(99,102,241,0.4)] transform -rotate-3 hover:-rotate-12 transition-all duration-300 cursor-pointer">
                            <span className="material-symbols-outlined text-white text-4xl">device_hub</span>
                        </div>
                    </div>
                    ...
                    <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
                        Welcome back, or{' '}
                        <Link to="/signup" className="font-bold text-primary hover:text-indigo-400 transition-colors underline decoration-primary/30 underline-offset-4">
                            apply for access
                        </Link>
                    </p>
                </div>
